  ...
  return `<div class="screen">
    <div class="content with-nav">
      ...
      <div class="countdown-card">
        <div class="countdown-label">${allDone ? 'Next session in' : 'Session resets in'}</div>
        <div class="countdown-time" id="countdown-time">${calcCountdown()}</div>
      </div>

      ${!allDone ? `<div class="today-progress">
        <div class="prog-label">${done} of ${total} completed today</div>
